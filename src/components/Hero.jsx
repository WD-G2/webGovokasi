...
// FROM https://tailwindcomponents.com/component/about-us
function Hero() {
  return (
        ...
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
          <div class=" relative ">
            ...
            <div class="lg:max-w-xl lg:pr-5 relative z-40">
              <p class="flex text-sm uppercase text-g1  ">GOVOKASi</p>
              ...
              <div class="mt-10 flex flex-col items-center md:flex-row">
                <a
                  href="/"
                  class="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-[#1a1d40] px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-white hover:text-[#1a1d40] focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                >
                  Be our Talent
                </a>
                <a
                  href="/"
                  class="mb-3 inline-flex h-12 w-full items-center justify-center rounded px-6 font-medium tracking-wide text-[#1a1d40] shadow-md transition hover:bg-[#1a1d40] hover:text-white focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                >
                  Be our Partner
                </a>
              </div>
          ...
          <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
            ...
            <div class="abg-orange-400 mx-auto w-fit overflow-hidden ">
              <img src={collage} />
            </div>
          </div>
        </div>
