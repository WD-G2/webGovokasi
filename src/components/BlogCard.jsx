  ...
  return (
    <article className="bg-white  p-6 mb-6 shadow transition duration-300 group transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer border">
      ...
      <div className="relative mb-4">
        ...
        <a
          className="flex justify-center items-center bg-[#1a1d40] bg-opacity-80 z-10 absolute top-0 left-0 w-full h-full text-white opacity-0 transition-all duration-300 transform group-hover:scale-105 text-xl group-hover:opacity-100"
          href="/blog/slug"
          target="_self"
